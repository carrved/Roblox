...
Library:SetWatermark("Lithium V2 | " .. string.sub(game:GetService("Stats").Workspace.FPS:GetValue(), 0, 4) .. "fps | " .. string.sub(game:GetService("Stats").PerformanceStats.Ping:GetValue(), 0, 4) .. "ms | Kill Yourself!!!")

local Window = Library:CreateWindow("Lithium V2 | 2017 Pro-League Edition")
