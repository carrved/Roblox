...
local tex2make = {"==================","","checkbl0x 0.9.5", "", "Proudly written in vscode", "(c) 69-420 spec", "", "This software is not for sale", "If you have purchased this, please", "report the seller.", "", "==================", "Enabling HAX ... done!", "UHH: Found nothing"}
